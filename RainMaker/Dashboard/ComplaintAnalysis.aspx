                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="panel panel-yellow">
                                        <div class="panel-heading">
                                            <div class="row">
                                                <div style="text-align:center; font-size: 13px; background-color : white;color : grey;font-weight : bold;">Region Wise Complaints</div>
                                                <br/>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="panel panel-red">
                                        <div class="panel-heading">
                                            <div class="row">
                                                <div style="text-align:center; font-size: 13px; background-color : white;color : grey;font-weight : bold;">DownTime Wise Complaints</div>
                                                <br/>
                                                <%--<div class="col-xs-3">--%>
                                                    <div class="col-xs-9">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="panel panel-green">
                                        <div class="panel-heading">
                                            <div class="row">
                                                <div style="text-align:center; font-size: 13px; background-color : white;color : grey;font-weight : bold;">Department Wise Complaints</div>
                                                <br/>
                                    ...
                                    <%-- New Row for Customer Graph & RFO Table --%>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h3 class="panel-title">Customer those Complaints more then 2 withing 14 Days.</h3>
                                                    </div>
                                                    <div class="panel-body">
                    ...
                    function LoadLast30DaysOnCall() {
                        ...
                        function LoadTop10wise(data) {
                            var chart = new CanvasJS.Chart("Top10Chart", {
                                title: {
                                    text: "TOP 10 Customer having Maximum Complaints",
                                    fontWeight: "bold",
                                    fontFamily: "calibri"
